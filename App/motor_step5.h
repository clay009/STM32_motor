...
#define PHASE_B_RISING	 	TIM_SetCompare2(TIM1,pwm_duty_gap*(DUTY_STEP*2 -duty_count))
#define PHASE_B_FALLING 	TIM_SetCompare2(TIM1,pwm_duty_gap*(duty_count-DUTY_STEP*5))
...
#define PHASE_C_RISING	 	TIM_SetCompare3(TIM1,pwm_duty_gap*(DUTY_STEP*2 -duty_count))
#define PHASE_C_FALLING 	TIM_SetCompare3(TIM1,pwm_duty_gap*(duty_count-DUTY_STEP*5))
...
#define PHASE_D_RISING	 	TIM_SetCompare2(TIM1,pwm_duty_gap*(DUTY_STEP*2 -duty_count))
#define PHASE_D_FALLING 	TIM_SetCompare2(TIM1,pwm_duty_gap*(duty_count-DUTY_STEP*5))
...
#define PHASE_E_RISING	 	TIM_SetCompare3(TIM1,pwm_duty_gap*(DUTY_STEP*2 -duty_count))
#define PHASE_E_FALLING 	TIM_SetCompare3(TIM1,pwm_duty_gap*(duty_count-DUTY_STEP*5))
#else
